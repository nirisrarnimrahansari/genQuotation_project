    ...
    <div class="container-fluid">
        <div class="row">
            <div class="offset-md-1 col-md-10"> 
                <form  method="post" action="{{route('discount.update',[$discounts->id])}}"> 
                @csrf
                @method('PATCH')
                    <div class="card">
                        <div class="card-header card-header-primary bg-primary">
                            <h4 class="card-title text-white" >{{ __('DISCOUNT EDIT FORM') }}</h4>
                        </div>
                        ...
                        <div class="form-group col-md-12 ml-2">
                            ...
                            <a class="btn btn-md fs-1 btn-light" href="/discount" >Cancel</a>
                        </div>
                    </div>
                </form>    
            </div>
